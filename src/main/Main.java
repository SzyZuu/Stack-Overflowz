...
public class Main {
    public static void main (String[] args){
        ...
        tutorialLabel.setText("<html>Short tutorial:<br> Drag cards around (IMPORTANT: slowly)<br> Stack 2 cards to craft <br> Press [SPACE] to buy cards (5 coins) <br> drag cards off spawning tile to use <br> drag cards to the top right tile to sell them <br><br> Card Guide: <br> White: Villager <br> Green: Tree <br> Dark Gary: Boulder <br> Brown: Wood <br> Light Gary: Stone <br> Beige: Plank <br> Crimson: Brick <br> Blue Gary: House Material <br> Blue: House <br> Faded Red: Used up House <br><br> Recipe Guide: <br> Experiment and find out (no hand holding, you're old enough) <br><br> If something breaks, it's your fault, just restart, that's just extra difficulty</html>");   //use html in label for easier formatting (could've made a separate file for that but too much work and not that necessary)
